...
import datetime
import uuid
from backend_airtable.posts_airtable import *
...
BACKEND_DIR = os.path.join(BASE_DIR, "backend_airtable")
...
from backend_airtable.registration_airtable import validate_registration
from backend_airtable.posts_airtable import PostAirtable
from backend_airtable.editing_profile_airtable import update_personal_info, delete_account  # ✅ Ajout pour profil
from backend_airtable.notification_airtable import FollowRequestNotification
...
def load_posts_bis(db):
    ...
    for p in raw_posts:
        ...
        post = PostAirtable.__new__(PostAirtable)
...
def feed():
    ...
    if request.method == "POST":
        ...
        # Crée le Post
        new_post = PostAirtable(content, session["username"], db, image_filename)
